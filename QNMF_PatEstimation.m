function [ EPat W ] = QNMF_PatEstimation( NL_mat, Self_arr, Sigma_arr, CurPat, Par)
        ...
        for  i      =  1 : length(Self_arr)                                    % For each keypatch group
            ...
            E_Temp 	=   QNMF( Temp, Par.c, Sigma_arr(Self_arr(i)), M_Temp, Par.ReWeiIter); % WNNM Estimation 
